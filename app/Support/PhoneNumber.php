...
class PhoneNumber
{
    ...
    private const CALLING_CODES = [
        ...
        'NG' => '234', 'NU' => '683', 'NF' => '672', 'MK' => '389', 'MP' => '1',
        ...
        'SJ' => '47', 'SE' => '46', 'CH' => '41', 'SY' => '963', 'TW' => '886',
        ...
        'VU' => '678', 'VA' => '39', 'VE' => '58', 'VN' => '84', 'VG' => '1',
        'VI' => '1', 'WF' => '681', 'EH' => '212', 'YE' => '967', 'ZM' => '260',
        'ZW' => '263',
    ];
    ...
    /**
     * Normalize phone to Shopify E.164 (+923001234567). Empty → null.
     */
    public static function toE164(?string $phone, ?string $countryCode = null): ?string
    {
        ...
        if (str_starts_with($raw, '+')) {
            ...
            $digits = preg_replace('/\D+/', '', $raw) ?: '';
            $callingCode = self::callingCode($countryCode);
